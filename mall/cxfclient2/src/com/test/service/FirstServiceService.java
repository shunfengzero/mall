 ...
 * 
 */
@WebServiceClient(name = "FirstServiceService", targetNamespace = "http://service.test.com/", wsdlLocation = "http://localhost:8080/services/first?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FIRSTSERVICESERVICE_QNAME = new QName("http://service.test.com/", "FirstServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/services/first?wsdl");
    ...
    public FirstService getFirstServicePort() {
        return super.getPort(new QName("http://service.test.com/", "FirstServicePort"), FirstService.class);
    }
    ...
    public FirstService getFirstServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.test.com/", "FirstServicePort"), FirstService.class, features);
    }
