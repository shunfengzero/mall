    ...
    <div id="show">
        ...
        <div class="cart-inner">
                ...
                <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
                    <div class="item_form clearfix">
                        ...
                        <div class="cell p-goods">
                            <div class="p-img">
                                <a href="/item/${item.sku}.html" target="_blank">
                                    <img clstag="clickcart|keycount|xincart|p-imglistcart" src="/images/543b4d75N686689d7.jpg" alt="${item.name}" width="52" height="52">
                                </a>
                            </div>
                            <div class="p-name">
                                <a href="/item/${item.sku}.html" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">
                        ...
                        <div class="cell p-quantity" for-stock="for-stock-11345721">
                            <div class="quantity-form" data-bind="">
                                ...
                                <input type="text" class="quantity-text" itemPrice="${item.price}" itemId="${item.sku}"  value="${item.num}" id="changeQuantity-11345721-1-1-0">
            ...
            <div class="cart-toolbar clearfix">
                <div class="total fr">
                    <p>总计：${total}¥<span class="totalSkuPrice">

                    </span></p>
                    <p><span id="totalRePrice">${total-zhekou}</span>优惠：</p>
                </div>
              ...
              <span class="column t-checkbox form">
                ...
                <div class="cart-total-2014">
                  ...
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="/order/toOrder" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去结算<b></b></a>
                  </span>
